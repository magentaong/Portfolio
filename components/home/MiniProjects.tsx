      ...
      <div className="container px-1">
        ...
        >
          ...
          <p className="text-muted-foreground md:text-lg px-8">
            Small builds and weekend side quests
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="relative w-full aspect-video overflow-hidden bg-muted">
                  {current.video ? (
                    ...
                    <Image
                      src={current.image ?? "/images/portfolio-preview.png"}
                  ...
                  <div className="absolute top-3 right-3">
                    <span
                      className={`text-xs px-3 py-1 rounded-full font-medium backdrop-blur-sm ${statusStyles[current.status]}`}
                    >
                ...
                <div className="p-4 md:px-8">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4 line-clamp-4 md:line-clamp-none">
                    {current.description}
                  </p>
